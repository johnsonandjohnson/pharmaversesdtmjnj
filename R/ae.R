#' @title ae
#'
#' @description ae modified from pharmaversesdtm
#' @source data from pharmaversesdtm.
#'
#' @format A data frame with 1191 rows and 36 variables:
#' \describe{
...
#' }
#' @seealso \code{\link{ae}} \code{\link{ds}} \code{\link{ds.xpt}} \code{\link{dv}} \code{\link{dv.xpt}} \code{\link{ie}} \code{\link{ie.xpt}} \code{\link{mh}} \code{\link{mh.xpt}}
